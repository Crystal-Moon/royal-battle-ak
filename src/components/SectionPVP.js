  ...
  render() {
    return (
      <section className="Section">
        ...
        <p>
          Ut ex odio, faucibus nec libero sed, luctus porttitor lectus. Duis
          ultricies elementum sollicitudin. Nulla vel imperdiet lacus. Duis
          sollicitudin ante at augue laoreet, sed pharetra enim tincidunt.
          Nullam sem massa, facilisis quis justo ut, placerat viverra nisl. Nunc
          sit amet convallis nulla. Mauris at ipsum dictum, tristique nisl in,
          pretium mauris. <br />
          Integer vel leo ultricies, facilisis nulla ut, venenatis orci.
          Phasellus ultricies dui felis. Suspendisse quis leo leo. Etiam eu
          augue a erat ornare volutpat. Mauris felis diam, sodales et eleifend
          aliquam, ullamcorper eget lectus. Donec ac ex neque. Nam varius
          volutpat elit, sed dictum nisl mollis at. Vestibulum eget lorem in
          ligula accumsan tincidunt tristique molestie mauris. Nunc iaculis
          ultricies purus et laoreet. Maecenas accumsan efficitur sem. Quisque
          pulvinar quam sit amet diam egestas luctus. Sed ullamcorper posuere
          ipsum, et facilisis nulla.
        </p>
        <img src=''alt="some img2" />
      </section>
    );
  }
}
